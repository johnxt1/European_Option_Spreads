A Python program that allows users to choose from a list of different European option spreads and price them via the Cox-Ross-Rubinstein (CRR) binomial model.
